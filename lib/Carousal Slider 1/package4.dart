...
class PackageFour extends StatelessWidget {
                        ...
                        children: [
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text('3 Day Max Offer',style: TextStyle(fontSize: 15,color: Colors.red.shade900,fontWeight: FontWeight.bold),),
                                Text('Validity: 3 days',style: TextStyle(fontSize: 10),),
                              ],
                            ),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text('Rs 46.0',style: TextStyle(fontSize: 15,color: Colors.amber),),
